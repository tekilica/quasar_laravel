    ...
    <div class="flex flex-col h-full justify-center items-center">
        <div class="p-[16px] rounded shadow bg-white">
            <div class="pb-[8px] border-b">
                <p class="text-xl">Upload video</p>
            </div>
            ...
            <label class="mt-[16px] block" for="video">Video</label>
            <input id="video" class="block w-[384px]" type="file" name="video" form="upload-form">
            ...
            <label class="mt-[16px] block" for="platform">Platform</label>
            <select id="platform" class="block w-[384px] rounded-full" name="platform" form="upload-form">
