<div class="relative rounded shadow bg-white overflow-hidden">
    ...
    <div class="pr-[48px] pb-[16px] pl-[16px] text-left">
        <b>{{ $video->name }}</b>
    </div>
    ...
    <input class="absolute right-[16px] bottom-[16px] rounded-full" type="checkbox" name="selectedIds[]" value="{{ $video->id }}" form="{{ $form }}">
